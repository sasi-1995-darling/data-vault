---- SRC LAYER ----
WITH
SRC_a              as ( SELECT ADDRESS_ID, ADDRNUMBER, ADDRORIGIN, ADDR_GROUP, ADRC_ERR_STATUS, ADRC_UUID, 
BUILDING, CHCKSTATUS, CITY1, CITY2, CITYH_CODE, CITYP_CODE, CITY_CODE, CITY_CODE2, CLIENT, COUNTRY, COUNTY, 
COUNTY_CODE, DATE_FROM, DATE_TO, DEFLT_COMM, DELI_SERV_NUMBER, DELI_SERV_TYPE, DONT_USE_P, DONT_USE_S, 
EXTENSION1, EXTENSION2, FAX_EXTENS, FAX_NUMBER, FLAGCOMM10, FLAGCOMM11, FLAGCOMM12, FLAGCOMM13, FLAGCOMM2, 
FLAGCOMM3, FLAGCOMM4, FLAGCOMM5, FLAGCOMM6, FLAGCOMM7, FLAGCOMM8, FLAGCOMM9, FLAGGROUPS, FLOOR, GLCHANGETIME, 
GLDELFLAG, GLREQUEST, GLSOURCESYSTEM, HOME_CITY, HOUSE_NUM1, HOUSE_NUM2, HOUSE_NUM3, ID_CATEGORY, LANGU, 
LANGU_CREA, LOCATION, MC_CITY1, MC_COUNTY, MC_NAME1, MC_STREET, MC_TOWNSHIP, NAME1, NAME2, NAME3, NAME4,
 NAME_CO, NAME_TEXT, NATION, PCODE1_EXT, PCODE2_EXT, PCODE3_EXT, PERS_ADDR, POSTALAREA, POST_CODE1, POST_CODE2, POST_CODE3, PO_BOX, PO_BOX_CTY, PO_BOX_LOBBY, PO_BOX_LOC, PO_BOX_NUM, PO_BOX_REG, PSA_DELETE_IND, PSA_LOAD_DTS, PSA_RECORD_SOURCE, REGIOGROUP, REGION, ROOMNUMBER, SORT1, SORT2, SORT_PHN, STREET, STREETABBR, STREETCODE, STR_SUPPL1, STR_SUPPL2, STR_SUPPL3, TAXJURCODE, TEL_EXTENS, TEL_NUMBER, TIME_ZONE, TITLE, TOWNSHIP, TOWNSHIP_CODE, TRANSPZONE, 
 UUID_BELATED, XPCPT FROM {{ source('sap_ecc_prd', 'z_adrc') }} as SRC  ),
